...
CREATE TABLE IF NOT EXISTS `mv_role` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `role_ename` char(255) DEFAULT NULL,
...
INSERT INTO `mv_role` (`id`, `role_ename`, `role_name`) VALUES
(1, 'admin', '管理员'),
(2, 'editor', '编辑'),
(3, 'normal', '普通会员');
...
INSERT INTO `mv_user` (`id`, `username`, `password`, `logintime`, `loginip`, `group`) VALUES
(1, 'admin', '21232f297a57a5a743894a0e4a801fc3', 1451358709, '127.0.0.1', 'admin'),
(15, 'thinksley', '165ffd639a48a59ec4c1cc361aca7edf', 1451550437, '127.0.0.1', 'admin');
